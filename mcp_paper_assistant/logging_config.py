"""Logging configuration for mcp-simple-server MCP server"""
...
def setup_logging(server_config: Optional[ServerSettings] = None) -> None:
    ...
    project_logger = logging.getLogger("mcp_paper_assistant")
    ...
    log_file = log_path / "mcp_paper_assistant.log"
...
logger = logging.getLogger("mcp_paper_assistant")
